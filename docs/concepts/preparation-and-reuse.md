...
Continue with [How notebook caching fits](caching) for the cell-level decision. Use
[Produce an export from Python](../reference/python/produce) for complete plan,
prepare, progress, result, and lease contracts.
