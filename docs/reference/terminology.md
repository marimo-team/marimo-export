...
| Artifact lease          | A live ownership record that protects one prepared state, export generation, or detached prepared file from retention.                                           |
...
Read [States and inputs](../concepts/states-and-inputs), [Outputs and
representations](../concepts/outputs-and-representations), [Preparation and
reuse](../concepts/preparation-and-reuse), and [Integrity and
trust](../concepts/integrity-and-trust) for the worked model.
