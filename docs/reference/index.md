...
marimo-export?](../overview) for the product model.
...
| Run commands and consume machine output              | [CLI](cli)                                |
...
| Serve publications and commit application directories | [Delivery and publications](python/delivery-and-publications)     |
| Integrate an interactive marimo host                  | [Host integration](python/host-integration)                       |
| Construct protocol records and handle failures        | [Format records and errors](python/format-records-and-errors)     |
...
| Follow a mutable manifest and commit state changes | [Prepared publications](browser/prepared-publications) |
...
- [Portable JSON](portable-json) defines the shared Python and JavaScript
